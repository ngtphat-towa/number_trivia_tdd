...
void main() {
  ...
  final triviaFixtureJson = fixture('trivia.json');
  ...
  void setUpMockHttpClientSuccess200() {
    when(mockHttpClient.get(any, headers: anyNamed('headers'))).thenAnswer(
      (_) async => http.Response(triviaFixtureJson, 200),
    );
  }
  ...
  group('getConcreteNumberTrivia', () {
    ...
    final tNumberTriviaModel =
        NumberTriviaModel.fromJson(json.decode(triviaFixtureJson));
    test(
      ...
      verify(mockHttpClient.get(
        Uri.parse('$numbersApiUrl/$tNumber'),
  ...
  group('getRandomNumberTrivia', () {
    ...
    test(
      ...
      () {
        ...
        // assert
        verify(mockHttpClient.get(
          Uri.parse('$numbersApiUrl/random'),
          headers: {'Content-Type': 'application/json'},
        ));
      },
    );
